...
<xsl:param name="TITLE">Safety Line Test Report</xsl:param>
...
<xsl:template name="pageHeader">
	...
	<img width="auto" height="50" alt="$TITLE" src="../media/img/logo-safetyline.png"/>
    <table width="100%">
    <tr>
        <td align="left"></td>
        <td align="right"><a href="mailto:olivier.lam@safety-line.fr" style="color:#c0c0c0;text-decoration:none;">Olivier Lam</a></td>
    </tr>
    </table>
    <hr size="1"/>
</xsl:template>
...
<xsl:template match="testcase" mode="print.test">
    <tr valign="top">
		...
		<td valign="middle" align="center">
			<a href="report/screenshot/{@name}"><img height="15" src="../media/img/screenshot-icon.png"/></a>
		</td>
    </tr>
</xsl:template>
